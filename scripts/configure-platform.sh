...
# File paths (absolute)
EXTERNAL_DNS_VALUES="$REPO_ROOT/gitops/sandbox/platform/external-dns/values.yaml"
CERT_MANAGER_ISSUER="$REPO_ROOT/gitops/sandbox/platform/cert-manager/cluster-issuer.yaml"
ESO_SECRETSTORE="$REPO_ROOT/gitops/sandbox/platform/secret-management/external-secret-store.yaml"
