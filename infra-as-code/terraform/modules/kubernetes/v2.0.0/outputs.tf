...
output "identity_client_id" {
  ...
  value       = module.user_assigned_identity.identity.client_id
}

output "identity_id" {
  description = "The resource ID of the user-assigned managed identity."
  value       = module.user_assigned_identity.identity.resource_id
}

output "identity_principal_id" {
  description = "The principal ID of the user-assigned managed identity. Used for RBAC assignments."
  value       = module.user_assigned_identity.identity.principal_id
}
