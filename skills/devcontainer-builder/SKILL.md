...
### Optional: Trail of Bits skill plugins

The base image installs only the official `anthropics/skills` plugin. If you want to add the [Trail of Bits](https://github.com/trailofbits) security-focused skill plugins, you can install them manually inside the running container:
...
Or add them to the Dockerfile install block before building:
...
Review the plugin source before adding: these extend what Claude can do and run with your permission settings.
